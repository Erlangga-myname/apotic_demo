...
class _RegistrationPageState extends State<RegistrationPage> {
  ...
  void _registerUser() async {
    ...
    print("All Good!");
    // Firebase handles email uniqueness automatically.
    // Username uniqueness could be handled via a custom collection if needed,
    // for now we skip local DB check.
    ...
    User newUser = User(
      id: 0,
      uid: '', // Will be updated if registration is successful
      username: username,
      password: password,
      email: email,
      namaLengkap: nama,
    ...
    FirebaseService()
        ...
        .then((User? registeredUser) {
          ...
          if (isSuccess) {
            newUser.uid = registeredUser.uid;
          }
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Title(
                child: const Text(
                  "Silahkan Masukan Data Diri Anda Untuk Membuat Akun Apotic.",
                  textScaleFactor: 1.2,
                ),
                color: Colors.black,
              ),
